...
export APP_NAME='mqube-go-common'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/mqube-go-common:0.23.1'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='jx3mqubebuild.azurecr.io'
export REPO_NAME='mqube-go-common'
